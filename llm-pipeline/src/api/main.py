...
from src.data.datapipeline.minio_service import MinioService
from src.data.datapipeline.data_parser import DataParser
from src.data.datapipeline.metrics_processor import MetricsProcessor
from src.data.datapipeline.snapshot_generator import SnapshotGenerator
from src.data.datapipeline.prompt_generation import PromptFormatter
...
def get_prompt():
    try:
        ...
        snapshots, _, _ = generator.generate_prompts_from_df(df, window_minutes=2)
