...
def exclude_paths(root, patterns, dockerfile=None):
    ...
    if dockerfile is None:
        dockerfile = 'Dockerfile.agent.prompt_api'
...
def mkbuildcontext(dockerfile):
    ...
    if isinstance(dockerfile, io.StringIO):
        dfinfo = tarfile.TarInfo('Dockerfile.agent.prompt_api')
        ...
        dfinfo = t.gettarinfo(fileobj=dockerfile, arcname='Dockerfile.agent.prompt_api')
