...
class TestModuleFinder:
    ...
    EXAMPLES = {
        ...
        "include": (
            ["my_tools.py", "fole.py", "other.py"],
            {"include": ["f*"], "exclude": ["fo*"]},
            ["file"],
        ),
        "invalid-name": (["my-my_tools.py", "other.my_tools.py"], {}, []),
    }
...
class TestFlatLayoutModuleFinder:
    ...
    EXAMPLES = {
        ...
        "common-names": (
            ["setup.py", "conftest.py", "agent.py", "tests.py", "example.py", "mod.py"],
            ["mod"],
        ),
        "tool-specific": (
