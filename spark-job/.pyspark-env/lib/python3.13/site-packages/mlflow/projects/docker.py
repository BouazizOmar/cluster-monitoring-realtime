...
_GENERATED_DOCKERFILE_NAME = "Dockerfile.agent.prompt_api.mlflow-autogenerated"
...
def _create_docker_build_ctx(work_dir, dockerfile_contents):
    """
    Creates build context tarfile containing Dockerfile.agent.prompt_api and project code, returning path to tarfile
    """
