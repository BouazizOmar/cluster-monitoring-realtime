...
def generate_dockerfile(
    ...
    """
    Generates a Dockerfile.agent.prompt_api that can be used to build a docker image, that serves ML model
    ...
    with open(os.path.join(output_dir, "Dockerfile.agent.prompt_api"), "w") as f:
        f.write(
